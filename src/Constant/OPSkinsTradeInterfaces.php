...
class OPSkinsTradeInterfaces
{
    ...
    const SEND_OFFER = 'https://%s@api-trade.opskins.com/ITrade/SendOffer/v1/?trade_url=%s&items=%s';
    ...
    const ACCEPT_OFFER = 'https://%s@api-trade.opskins.com/ITrade/AcceptOffer/v1/?offer_id=%s';
}
